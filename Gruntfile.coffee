...
module.exports = (grunt) ->
  ...
  grunt.initConfig
    ...
    watch:
      ...
      coffeescript:
        files: ['<%= config.app %>/scripts/**/*.coffee','<%= config.app %>/workers/**/*.coffee']
        tasks: ['coffeelint', 'coffee:server', 'coffee:serverWorkers']
        options:
          spawn: false
    ...
    less:
      dev:
        files:
          "<%= config.app %>/styles/main.css": "<%= config.app %>/styles/*.less"
